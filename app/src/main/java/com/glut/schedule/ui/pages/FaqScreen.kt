...
private val faqItems = listOf(
    ...
    FaqItem(
        "参考了什么项目？",
        "参考了三个项目：\n1. https://github.com/nano71/GlutAssistantN\n2. https://github.com/flylai/GlutAssistant\n3. https://github.com/Jacknic/glut\n\n感谢前辈大佬，他们的时代可没有 AI ！"
    ),
    FaqItem(
        "这个app是自己手搓的吗？",
    ...
    FaqItem(
        "为什么想到开发这个项目？",
        "一是受够了易班经常崩溃、操作路径长的缺点（打开易班app --> 找到 in桂工 --> 登入验证 --> 终于看到了课表！）；二是 商店的课表app是商业软件，有开屏广告；三是最近 vibe coding 大火，鄙人也当一下弄潮儿！体验由idea到产出落地的感觉。四是融合更多的教务接口，例如考试安排、成绩查看、简易教学计划等集于一体，给桂工学子带来一丝丝的便利。"
    )
)
